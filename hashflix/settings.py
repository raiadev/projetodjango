...
SECRET_KEY = 'django-insecure-zpz@o&&u6*&#j!ztnabpnp*vx^wo_2q8_+x*wvl!0xksy804i$'
...
#link para onde será redirecionado quando fizer o login
LOGIN_REDIRECT_URL = 'filme:homefilmes'

#link onde o user faz o login
